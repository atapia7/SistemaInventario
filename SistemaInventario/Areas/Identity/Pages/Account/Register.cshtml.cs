...
namespace SistemaInventario.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            public string Role { get; set; } = DS.Role_Cliente;
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            {
                ListaRol = _roleManager.Roles.Where(r => r.Name != DS.Role_Cliente).Select(r => r.Name).Select(l => new SelectListItem
                {
                    Text = l,
                    Value = l
                })
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //await _emailSender.SendEmailAsync(Input.Email, "Confirmar tu email", $"Confirmar tu cuenta <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>clicking here</a>.");
